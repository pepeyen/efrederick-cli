    ...
    return (
        <React.Fragment>
            ...
            <div className = "cli__output-text">
                ...
                <p className = "cli__message"><strong className = "cli__message-command">/competences</strong> -- learn what <strong className = "cli__message-sender-reference">eFrederick</strong> is really made of</p><br></br>
